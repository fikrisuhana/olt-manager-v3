...
class OltModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'telnet_port', 'telnet_user', 'telnet_pass', 'enable_password',
        'snmp_community', 'snmp_port', 'tcont_profiles', 'traffic_profiles', 'vlan_profiles', 'description', 'acs_url', 'use_acs', 'acs_user', 'acs_pass', 'pppoe_vlan_profile', 'firmware_version',
    ];
